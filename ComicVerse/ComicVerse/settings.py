"""
Django settings for ComicVerse project.
...
ALLOWED_HOSTS = [host.strip() for host in os.environ.get('DJANGO_ALLOWED_HOSTS', 'https://comic-api-40o4.onrender.com,localhost,127.0.0.1,*').split(',') if host.strip()]
...
AUTH_USER_MODEL = 'ComicApp.CustomUser'
